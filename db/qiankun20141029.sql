...
-- 正在导出表  qiankun.qiankun_access 的数据：47 rows
...
-- 正在导出表  qiankun.qiankun_form 的数据：0 rows
...
-- 正在导出表  qiankun.qiankun_node 的数据：17 rows
...
INSERT INTO `qiankun_node` (`id`, `name`, `title`, `status`, `remark`, `sort`, `pid`, `level`, `type`, `group_id`) VALUES
	...
	(1, 'QianKun', 'Rbac后台管理', 1, '', NULL, 0, 1, 0, 0),
	(50, 'main', '空白首页', 1, '', NULL, 40, 3, 0, 0),
	(86, 'top', '后台顶端', 1, NULL, NULL, 40, 3, 0, 0),
	(85, 'menu', '后台菜单', 1, NULL, NULL, 40, 3, 0, 0);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员', '21232f297a57a5a743894a0e4a801fc3', '', 1414572750, '127.0.0.1', 914, '8888', 'liu21st@gmail.com', '备注信息', 1222907803, 1326266696, 1, 0, ''),
	(2, 'demo', '演示', 'fe01ce2a7fbac8fafaed7c982a04e229', '', 1414569812, '127.0.0.1', 118, '8888', '', '', 1239783735, 1254325770, 1, 0, ''),
	(3, 'member', '员工', 'aa08769cdcb26674c6706093503ff0a3', '', 1326266720, '127.0.0.1', 17, '', '', '', 1253514375, 1254325728, 1, 0, ''),
	(4, 'leader', '领导', 'c444858e0aaeb727da73d2eae62321ad', '', 1414564743, '127.0.0.1', 16, '', '', '领导', 1253514575, 1254325705, 1, 0, '');
