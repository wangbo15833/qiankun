...
-- 正在导出表  qiankun.qiankun_category 的数据：26 rows
...
-- 正在导出表  qiankun.qiankun_node 的数据：18 rows
...
-- 正在导出表  qiankun.qiankun_shop 的数据：1 rows
/*!40000 ALTER TABLE `qiankun_shop` DISABLE KEYS */;
INSERT INTO `qiankun_shop` (`id`, `shopname`, `phone`, `address`, `info`, `point_x`, `point_y`, `add_time`, `update_time`, `province`, `city`, `area`, `category_id`) VALUES
	(0, 'aaa', '6546', 'aaaa', 'gfdfgdfghd<br />', '', '', '', '', '', '', '', 0);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1415339293, '127.0.0.1', 950, '8888', 'liu21st@gmail.com', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
