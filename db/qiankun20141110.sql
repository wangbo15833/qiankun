...
-- 正在导出表  qiankun.qiankun_access 的数据：50 rows
...
CREATE TABLE IF NOT EXISTS `qiankun_area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='省市列表';

-- 正在导出表  qiankun.qiankun_area 的数据：54 rows
...
CREATE TABLE IF NOT EXISTS `qiankun_shop` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='店铺表';
...
INSERT INTO `qiankun_shop` (`id`, `shopname`, `phone`, `address`, `info`, `point_x`, `point_y`, `add_time`, `update_time`, `province`, `city`, `area`, `category_id`, `owner`) VALUES
	...
	(5, '', '', '', '', '', '', '', '', '', '', '', 0, 3),
	(6, '222222', '', '', '', '', '', '', '', '', '', '', 0, 3),
	(7, '5555555', '', '', '', '', '', '1415610084', '1415610084', '', '', '', 0, 3),
	(8, '66666', '', '', '', '', '', '1415610483', '1415610483', '', '', '', 4, 3);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1415604900, '127.0.0.1', 967, '8888', 'liu21st@gmail.com', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'demo', '演示', 'fe01ce2a7fbac8fafaed7c982a04e229', '', 1414742853, '127.0.0.1', 125, '8888', '', '', 1239783735, 1254325770, 1, 0, ''),
	(3, 'member', '员工', 'aa08769cdcb26674c6706093503ff0a3', '', 1415608851, '127.0.0.1', 20, '', '', '', 1253514375, 1254325728, 1, 0, ''),
