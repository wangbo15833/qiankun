...
-- 正在导出表  qiankun.qiankun_node 的数据：30 rows
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1415845577, '127.0.0.1', 976, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1415865267, '127.0.0.1', 51, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
	...
	(38, 'seller3', '我是商家3', 'e10adc3949ba59abbe56e057f20f883e', '', 1415865474, '127.0.0.1', 3, '7051', 'abc@bcd.com', '13191813605', '', 1415864953, 1415864953, 1, 0, '');
