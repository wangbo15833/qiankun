...
CREATE TABLE IF NOT EXISTS `qiankun_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='平台商品表';

-- 正在导出表  qiankun.qiankun_goods 的数据：6 rows
/*!40000 ALTER TABLE `qiankun_goods` DISABLE KEYS */;
INSERT INTO `qiankun_goods` (`id`, `name`, `new_price`, `old_price`, `status`, `info`, `shopid`, `category_id`, `add_time`, `update_time`) VALUES
	(1, '商品1', 10.24, 10.25, 0, '商品1吸纳感情<br />', 14, 1, 0, 0),
	(2, '商品21', 22.212, 22.231, 0, '商品详情2111111111<br />', 14, 4, 0, 1416227864),
	(3, '我的第三件商品', 10.21, 10.22, 0, '商品详情介绍<br />', 14, 5, 1416216439, 1416216439),
	(4, '商品4', 20, 20.01, 1, '滴答滴答滴答滴答滴答滴答滴答答<br />', 14, 3, 1416227043, 1416227043),
	(5, '商品5', 20.75, 20.85, 1, '&nbsp;滴答滴答滴答滴答答<br />', 14, 4, 1416227469, 1416227469),
	(6, '商品11', 10.24, 10.25, 1, '商品1吸纳感情1<br />', 14, 1, 1416227581, 1416227581);
...
INSERT INTO `qiankun_shop` (`id`, `shopname`, `phone`, `address`, `info`, `point_x`, `point_y`, `add_time`, `update_time`, `province`, `city`, `area`, `category_id`, `owner`) VALUES
	...
	(14, '第三家店铺', '777777', '秦皇岛', '斤斤计较斤斤计较斤斤计较斤斤计较经济<br />', '119.604512', '39.945296', '1415678973', '1416228624', '15', '1502', '150204', 30, 3);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	...
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1416227526, '0.0.0.0', 67, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
