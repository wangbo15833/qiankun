...
INSERT INTO `qiankun_goods` (`id`, `name`, `thumb_img`, `new_price`, `old_price`, `status`, `info`, `shopid`, `category_id`, `add_time`, `update_time`) VALUES
	(1, '商品1', '', 10.24, 10.25, 0, '商品1吸纳感情<br />', 14, 1, 0, 0),
	(2, '商品2', '', 22.21, 22.23, 0, '商品详情2<br />', 14, 4, 0, 0),
	(3, '我的第三件商品', '', 10.21, 10.22, 0, '商品详情介绍<br />', 14, 5, 1416216439, 1416216439),
	(4, '我的第5件商品', '', 20, 20.03, 1, '哈哈哈哈哈哈<br />', 14, 1, 1416557882, 1416557882),
	(5, '我的第6件商品', '546ef7814f42f.jpg', 25, 26, 1, '靠靠靠靠靠靠靠靠靠<br />', 14, 1, 1416558465, 1416558465),
	(6, '就斤斤计较', '546ef8017c508.jpg', 25.2, 25.3, 1, '就就斤斤计较<br />', 14, 1, 1416558593, 1416558593),
	(7, '复反反复复反反复复', '', 2, 20.3, 1, '靠靠靠靠靠靠靠靠靠靠靠<br />', 14, 1, 1416560116, 1416560116),
	(8, '啊啊啊啊啊啊啊啊啊啊啊1', '546effe64b2ed.jpg', 51, 61, 1, 'iiiiiiiiiiiii就就斤斤计较11<br />', 14, 1, 1416560172, 1416560850),
	(9, '5555555', '546eff7967918.jpg', 55, 55, 1, '55555555555<br />', 14, 1, 1416560505, 1416560505);
...
CREATE TABLE IF NOT EXISTS `qiankun_goods_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品类目表';

-- 正在导出表  qiankun.qiankun_goods_category 的数据：5 rows
/*!40000 ALTER TABLE `qiankun_goods_category` DISABLE KEYS */;
INSERT INTO `qiankun_goods_category` (`id`, `name`, `pid`, `shopid`, `info`, `add_time`, `update_time`, `sort`) VALUES
...
INSERT INTO `qiankun_node` (`id`, `name`, `title`, `status`, `remark`, `sort`, `pid`, `level`, `type`, `group_id`) VALUES
	...
	(32, 'GoodsCategory', '商品类目管理', 1, '', NULL, 7, 2, 0, 0),
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1416212723, '127.0.0.1', 982, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1416556324, '127.0.0.1', 65, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
