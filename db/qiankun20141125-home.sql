...
CREATE TABLE IF NOT EXISTS `qiankun_goods_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='总站商品类目表';

-- 正在导出表  qiankun.qiankun_goods_category 的数据：6 rows
/*!40000 ALTER TABLE `qiankun_goods_category` DISABLE KEYS */;
INSERT INTO `qiankun_goods_category` (`id`, `name`, `pid`, `info`, `add_time`, `update_time`, `sort`) VALUES
	(1, '站内商品分类1', 0, NULL, 1416203080, 1416203080, 0),
	(2, '站内商品分类2', 0, NULL, 1416203080, 1416203080, 0),
	(3, '站内商品分类3', 0, NULL, 1416203080, 1416203080, 0),
	(4, '站内abc111', 1, NULL, 1416203325, 1416881798, 0),
	(5, '站内vvvv', 4, NULL, 1416204824, 1416204971, 0),
	(7, '站内类目1测试', 0, NULL, 1416881496, 1416881496, 0);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1416880401, '127.0.0.1', 984, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1416878306, '127.0.0.1', 67, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
