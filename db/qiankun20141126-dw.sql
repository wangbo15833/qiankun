...
INSERT INTO `qiankun_goods` (`id`, `name`, `thumb_img`, `new_price`, `old_price`, `status`, `info`, `shopid`, `category_id`, `inshop_category`, `add_time`, `update_time`) VALUES
	(1, '商品1', '', 10.24, 10.25, 0, '商品1吸纳感情<br />', 14, 1, 0, 0, 0),
	(2, '商品2', '', 22.21, 22.23, 0, '商品详情2<br />', 14, 4, 0, 0, 0),
	(3, '我的第三件商品', '', 10.21, 10.22, 0, '商品详情介绍<br />', 14, 5, 0, 1416216439, 1416216439),
	(4, '我的第5件商品', '', 20, 20.03, 1, '哈哈哈哈哈哈<br />', 14, 1, 0, 1416557882, 1416557882),
	(5, '我的第6件商品', '546ef7814f42f.jpg', 25, 26, 1, '靠靠靠靠靠靠靠靠靠<br />', 14, 1, 0, 1416558465, 1416558465),
	(6, '就斤斤计较', '546ef8017c508.jpg', 25.2, 25.3, 1, '就就斤斤计较<br />', 14, 1, 0, 1416558593, 1416558593),
	(7, '复反反复复反反复复', '', 2, 20.3, 1, '靠靠靠靠靠靠靠靠靠靠靠<br />', 14, 1, 0, 1416560116, 1416560116),
	(8, '啊啊啊啊啊啊啊啊啊啊啊1', '546effe64b2ed.jpg', 51, 61, 1, 'iiiiiiiiiiiii就就斤斤计较11<br />', 14, 1, 0, 1416560172, 1416560850),
	(9, '5555555', '546eff7967918.jpg', 55, 55, 1, '55555555555<br />', 14, 1, 0, 1416560505, 1416560505);
...
INSERT INTO `qiankun_goods_category` (`id`, `name`, `pid`, `info`, `add_time`, `update_time`, `sort`, `is_hot`) VALUES
	(1, '美食', 0, NULL, 1416983102, 1416983102, 0, NULL),
	(2, '休闲娱乐', 0, NULL, 1416983125, 1416983125, 0, NULL),
	(3, '酒店', 0, NULL, 1416983132, 1416983132, 0, NULL),
	(4, '丽人', 0, NULL, 1416983140, 1416983140, 0, NULL),
	(5, '购物', 0, NULL, 1416983147, 1416983147, 0, NULL),
	(6, '旅游', 0, NULL, 1416983154, 1416983154, 0, NULL),
	(7, '生活服务', 0, NULL, 1416983161, 1416983161, 0, NULL),
	(8, '亲子', 0, NULL, 1416983174, 1416983174, 0, NULL),
	(9, '结婚', 0, NULL, 1416983182, 1416983182, 0, NULL),
	(10, '甜品饮料', 1, NULL, 1416983662, 1416983662, 0, 1),
	(11, '自助餐', 1, NULL, 1416983674, 1416983674, 0, 1),
	(12, '火锅', 1, NULL, 1416983684, 1416983700, 0, 1),
	(13, '午市套餐', 1, NULL, 1416983725, 1416983725, 0, 1),
	(15, '下午茶', 1, NULL, 1416984526, 1416984526, 0, 1),
	(16, '日韩料理', 1, NULL, 1416984550, 1416984550, 0, 1),
	(17, '西餐', 1, NULL, 1416984559, 1416984559, 0, 1),
	(18, '小吃快餐', 1, NULL, 1416984571, 1416984571, 0, 1),
	(19, '烧烤烤鱼', 1, NULL, 1416984579, 1416984579, 0, 1),
	(20, '粤菜/茶餐厅', 1, NULL, 1416984596, 1416984596, 0, 1),
	(21, '江浙菜', 1, NULL, 1416984605, 1416984605, 0, 0),
	(22, '川湘菜', 1, NULL, 1416984616, 1416984616, 0, NULL),
	(23, '咖啡茶馆/酒吧', 1, NULL, 1416984892, 1416984892, 0, NULL),
	(24, '海鲜', 1, NULL, 1416984900, 1416984900, 0, NULL),
	(25, '东南亚菜', 1, NULL, 1416984911, 1416984911, 0, NULL),
	(26, '新疆/清真', 1, NULL, 1416984921, 1416984921, 0, NULL),
	(27, '西北/东北菜', 1, NULL, 1416984932, 1416984932, 0, NULL),
	(28, '京菜/鲁菜', 1, NULL, 1416984945, 1416984945, 0, NULL),
	(29, '汤/粥/炖菜', 1, NULL, 1416984959, 1416984959, 0, NULL),
	(30, '聚餐宴请', 1, NULL, 1416984970, 1416984970, 0, NULL),
	(31, '蟹宴', 1, NULL, 1416984995, 1416984995, 0, NULL),
	(32, '其他美食', 1, NULL, 1416985004, 1416985004, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='rbac节点表';

-- 正在导出表  qiankun.qiankun_node 的数据：33 rows
...
INSERT INTO `qiankun_shop` (`id`, `shopname`, `phone`, `address`, `info`, `point_x`, `point_y`, `add_time`, `update_time`, `province`, `city`, `area`, `owner`) VALUES
	...
	(2, '我的第一家店铺', '1111', '我的详细地址', '我的店铺详情介绍<br />', '', '', '', '', '15', '1502', '150201', 0),
	(3, '第二家店铺', '2222', '山海关区', '店铺详情<br />', '', '', '', '', '15', '1502', '150202', 0),
	(15, 'seller3的店铺', '123456', '哈哈', '', '119.538253', '39.928644', '1415951360', '1415951360', '15', '1502', '150206', 38),
	(14, '第三家店铺', '777777', '秦皇岛', '斤斤计较斤斤计较斤斤计较斤斤计较经济<br />', '119.604512', '39.945296', '1415678973', '1415778042', '15', '1502', '150204', 3);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1416983056, '127.0.0.1', 985, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1416993661, '192.168.1.128', 86, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
