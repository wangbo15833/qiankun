...
CREATE TABLE IF NOT EXISTS `qiankun_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='平台商品表';

-- 正在导出表  qiankun.qiankun_goods 的数据：13 rows
...
INSERT INTO `qiankun_goods_category` (`id`, `name`, `pid`, `info`, `add_time`, `update_time`, `sort`, `is_hot`, `is_floor`, `is_in_left`) VALUES
	...
	(10, '甜品饮料', 1, NULL, 1416983662, 1416983662, 0, 1, NULL, NULL),
	(11, '自助餐', 1, NULL, 1416983674, 1416983674, 0, 1, NULL, NULL),
	(12, '火锅', 1, NULL, 1416983684, 1416983700, 0, 1, NULL, NULL),
...
-- 正在导出表  qiankun.qiankun_orders 的数据：13 rows
/*!40000 ALTER TABLE `qiankun_orders` DISABLE KEYS */;
INSERT INTO `qiankun_orders` (`orderid`, `userid`, `goodsid`, `num`, `create_time`, `status`) VALUES
	('14172532732859', NULL, 2, NULL, NULL, NULL),
	('14172533637773', NULL, 2, NULL, NULL, NULL),
	('1', NULL, 2, NULL, NULL, NULL),
	('14172534598371', NULL, 2, NULL, NULL, NULL),
	('2', NULL, 2, NULL, NULL, NULL),
	('3', NULL, 2, NULL, NULL, NULL),
	('4', NULL, 2, NULL, NULL, NULL),
	('5', NULL, 2, NULL, NULL, NULL),
	('', NULL, NULL, NULL, 1417268742, NULL),
	('14172688146728', NULL, 5, NULL, 1417269230, NULL),
	('14172699196281', NULL, 5, 1, 1417269930, 0),
	('14172718027760', 40, NULL, 1, 1417271807, 0),
	('14172718473285', 40, 2, 1, 1417271850, 0);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1417270530, '0.0.0.0', 989, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1417323419, '0.0.0.0', 89, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
	(4, 'agent', '代理商', 'e10adc3949ba59abbe56e057f20f883e', '', 1415781719, '127.0.0.1', 39, '', '', '', '领导', 1253514575, 1415778129, 1, 0, ''),
	(40, 'SH_201411211531424950', '', 'e10adc3949ba59abbe56e057f20f883e', '', 1417321756, '0.0.0.0', 10, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
