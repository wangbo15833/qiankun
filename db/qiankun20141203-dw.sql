...
-- 正在导出表  qiankun.qiankun_orders 的数据：27 rows
/*!40000 ALTER TABLE `qiankun_orders` DISABLE KEYS */;
INSERT INTO `qiankun_orders` (`orderid`, `userid`, `goodsid`, `price`, `num`, `amount`, `create_time`, `status`, `address`, `paytype`) VALUES
	('14175910588783', 40, 2, 22.21, 1, 22.21, 1417591060, 1, '一个地方', 'hdfk'),
	('14175911477499', 40, 5, 25, 1, 25, 1417591150, 1, '一个地方', 'hdfk');
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	...
	(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1417572253, '127.0.0.1', 18, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
