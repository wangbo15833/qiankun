...
CREATE TABLE IF NOT EXISTS `qiankun_area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='省市列表' AUTO_INCREMENT=67 ;

--
-- 转存表中的数据 `qiankun_area`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_channel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='平台频道表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `qiankun_channel`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_form` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='rbac示例' AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `qiankun_form`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='平台商品表' AUTO_INCREMENT=26 ;

--
-- 转存表中的数据 `qiankun_goods`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_goods_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='总站商品类目表' AUTO_INCREMENT=45 ;

--
-- 转存表中的数据 `qiankun_goods_category`
--
...
--
-- 表的结构 `qiankun_goods_inshop_category`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_goods_inshop_category` (
  ...
  `sort` smallint(6) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='店内商品类目表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `qiankun_goods_inshop_category`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='rbac分组表' AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `qiankun_group`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='平台资讯表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='rbac节点表' AUTO_INCREMENT=38 ;

--
-- 转存表中的数据 `qiankun_node`
--
...
(36, 'Orders', '订单管理', 1, '', NULL, 7, 2, 0, 0),
(37, 'OrdersAged', '老年订单', 1, '', NULL, 7, 2, 0, 0);
...
--
-- 转存表中的数据 `qiankun_orders`
--

INSERT INTO `qiankun_orders` (`orderid`, `userid`, `shopid`, `goodsid`, `price`, `num`, `amount`, `create_time`, `status`, `address`, `paytype`) VALUES
('14175910588783', 40, NULL, 2, 22.21, 1, 22.21, 1417591060, 1, '一个地方', 'hdfk'),
('14175911477499', 40, NULL, 5, 25, 1, 25, 1417591150, 1, '一个地方', 'hdfk'),
('14177472632529', 40, 14, 13, 25.01, 1, 25.01, 1417747269, 1, '一个地方', 'hdfk');

-- --------------------------------------------------------

--
-- 表的结构 `qiankun_orders_aged`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='老年人订单';

--
-- 转存表中的数据 `qiankun_orders_aged`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_role` (
  ...
  KEY `ename` (`ename`),
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='rbac角色表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `qiankun_role`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_shop` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='店铺表' AUTO_INCREMENT=16 ;

--
-- 转存表中的数据 `qiankun_shop`
--
...
CREATE TABLE IF NOT EXISTS `qiankun_shop_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='店铺类目表(废弃不用)' AUTO_INCREMENT=31 ;

--
-- 转存表中的数据 `qiankun_shop_category`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='平台用户表' AUTO_INCREMENT=41 ;

--
-- 转存表中的数据 `qiankun_user`
--
...
(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1417847119, '127.0.0.1', 992, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1417856657, '127.0.0.1', 97, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
(4, 'agent', '代理商', 'e10adc3949ba59abbe56e057f20f883e', '', 1415781719, '127.0.0.1', 39, '', '', '', '领导', 1253514575, 1415778129, 1, 0, ''),
(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1417837871, '127.0.0.1', 22, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');

-- --------------------------------------------------------

--
-- 表的结构 `qiankun_user_expand`
--
