...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='rbac节点表';
...
-- 正在导出表  qiankun.qiankun_orders 的数据：3 rows
...
-- 正在导出表  qiankun.qiankun_shop_category 的数据：0 rows
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	...
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1418201052, '127.0.0.1', 99, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
