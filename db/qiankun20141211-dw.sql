...
-- 正在导出表  qiankun.qiankun_access 的数据：31 rows
...
-- 正在导出表  qiankun.qiankun_feedback 的数据：27 rows
...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='rbac节点表';

-- 正在导出表  qiankun.qiankun_node 的数据：40 rows
...
INSERT INTO `qiankun_orders` (`orderid`, `info`, `userid`, `phone`, `shopid`, `goodsid`, `price`, `num`, `amount`, `create_time`, `status`, `address`, `point_x`, `point_y`, `paytype`, `is_grab`) VALUES
	('14175910588783', '', 40, NULL, NULL, 2, 22.21, 1, 22.21, 1417591060, 1, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14175911477499', '', 40, NULL, NULL, 5, 25, 1, 25, 1417591150, 1, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14177472632529', '', 40, NULL, 14, 13, 25.01, 1, 25.01, 1417747269, 1, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14182158203892', '一瓶醋', 40, '13191813605', NULL, NULL, NULL, NULL, NULL, 1418215820, 1, '黄土高坡', '111', '222', 'aged', 14),
	('14182159227618', '一瓶酱油', 40, '13191813605', NULL, NULL, NULL, NULL, NULL, 1418215922, 1, '黄土高坡', '111', '222', 'aged', 14);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1418287271, '127.0.0.1', 1000, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1418258578, '127.0.0.1', 104, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
	(4, 'agent', '代理商', 'e10adc3949ba59abbe56e057f20f883e', '', 1415781719, '127.0.0.1', 39, '', '', '', '领导', 1253514575, 1415778129, 1, 0, ''),
	(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1418261444, '127.0.0.1', 28, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
