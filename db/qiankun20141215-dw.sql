...
-- 正在导出表  qiankun.qiankun_access 的数据：34 rows
...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='rbac节点表';

-- 正在导出表  qiankun.qiankun_node 的数据：44 rows
...
INSERT INTO `qiankun_node` (`id`, `name`, `title`, `status`, `remark`, `sort`, `pid`, `level`, `type`, `group_id`) VALUES
	...
	(38, 'ShopCategory', '店铺类目', 1, '', NULL, 1, 2, 0, 2),
	(39, 'grab', '抢单', 1, '', NULL, 37, 3, 0, 0),
	(40, 'GoodsFavorite', '商品收藏', 1, '', NULL, 19, 2, 0, 0),
	(41, 'Feedback', '意见反馈', 1, '', NULL, 1, 2, 0, 2),
	(42, 'confirm_goods', '订单确认', 1, '', NULL, 35, 3, 0, 0),
	(43, 'OrdersRate', '评价管理', 1, '', NULL, 19, 2, 0, 0),
	(44, 'deliver', '发货操作', 1, '', NULL, 37, 3, 0, 0),
	(45, 'deliver', '发货操作', 1, '', NULL, 36, 3, 0, 0),
	(46, 'OrdersRate', '订单评价', 1, '', NULL, 7, 2, 0, 0);
...
-- 正在导出表  qiankun.qiankun_orders 的数据：5 rows
...
INSERT INTO `qiankun_orders` (`orderid`, `info`, `userid`, `user_rate_id`, `phone`, `shopid`, `shop_rate_id`, `goodsid`, `price`, `num`, `amount`, `create_time`, `status`, `address`, `point_x`, `point_y`, `paytype`, `is_grab`) VALUES
	('14175910588783', '', 40, 9, NULL, 14, 10, 2, 22.21, 1, 22.21, 1417591060, 4, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14175911477499', '', 40, NULL, NULL, 14, NULL, 5, 25, 1, 25, 1417591150, 1, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14177472632529', '', 40, NULL, NULL, 14, NULL, 13, 25.01, 1, 25.01, 1417747269, 1, '一个地方', NULL, NULL, 'hdfk', NULL),
	('14182158203892', '一瓶醋', 40, 8, '13191813605', 14, 11, NULL, NULL, NULL, NULL, 1418215820, 4, '黄土高坡', '111', '222', 'aged', 14),
	('14182159227618', '一瓶酱油', 40, 7, '13191813605', 14, NULL, NULL, NULL, NULL, NULL, 1418215922, 3, '黄土高坡', '111', '222', 'aged', 14);
...
CREATE TABLE IF NOT EXISTS `qiankun_orders_rate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='订单评价表';

-- 正在导出表  qiankun.qiankun_orders_rate 的数据：7 rows
/*!40000 ALTER TABLE `qiankun_orders_rate` DISABLE KEYS */;
INSERT INTO `qiankun_orders_rate` (`id`, `orderid`, `starlevel`, `shopid`, `uid`, `info`, `add_time`, `type`) VALUES
	(1, '14182159227618', 2, NULL, NULL, '隐隐约约', NULL, NULL),
	(2, '14182159227618', 5, NULL, NULL, '靠靠靠靠靠靠靠靠', NULL, NULL),
	(3, '14182159227618', 1, NULL, 40, 'bbbbbbbbbb', 1418370369, NULL),
	(4, '14182159227618', 3, NULL, 40, '啦啦啦啦啦啦', 1418371027, NULL),
	(5, '14182159227618', 2, NULL, 40, 'ooooooooooo', 1418371071, NULL),
	(6, '14182159227618', 1, NULL, 40, '就就斤斤计较', 1418371156, NULL),
	(7, '14182159227618', 3, NULL, 40, 'hhhhhhhh', 1418371198, NULL),
	(8, '14182158203892', 3, 14, 40, '我的评价', 1418633927, 'c2s'),
	(9, '14175910588783', 3, 14, 3, '哈哈评价', 1418634342, 's2c'),
	(10, '14175910588783', 4, 14, 40, '乐乐评价', 1418634460, 's2c'),
	(11, '14182158203892', 4, 14, 40, '老年订单评价', 1418634600, 's2c');
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1418628173, '127.0.0.1', 1002, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	(2, 'user', '会员用户', 'e10adc3949ba59abbe56e057f20f883e', '', 1415849831, '127.0.0.1', 139, '8888', '', '', '', 1239783735, 1415839587, 1, 0, ''),
	(3, 'shop', '店主', 'e10adc3949ba59abbe56e057f20f883e', '', 1418634319, '127.0.0.1', 112, '', 'shop@abc.com', '', '哈哈哈', 1253514375, 1415758413, 1, 0, ''),
	(4, 'agent', '代理商', 'e10adc3949ba59abbe56e057f20f883e', '', 1415781719, '127.0.0.1', 39, '', '', '', '领导', 1253514575, 1415778129, 1, 0, ''),
	(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1418609454, '127.0.0.1', 36, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
