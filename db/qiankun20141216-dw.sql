...
CREATE TABLE IF NOT EXISTS `qiankun_lottery` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='抽奖项目表';

-- 正在导出表  qiankun.qiankun_lottery 的数据：0 rows
...
-- 正在导出表  qiankun.qiankun_node 的数据：48 rows
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1418718029, '127.0.0.1', 1005, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	...
	(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1418702753, '127.0.0.1', 42, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
