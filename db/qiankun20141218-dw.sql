...
-- 正在导出表  qiankun.qiankun_access 的数据：38 rows
...
INSERT INTO `qiankun_lottery` (`id`, `title`, `sub_title`, `thumb_img`, `status`, `info`, `start_time`, `end_time`, `add_time`, `number`) VALUES
	...
	(7, '抽奖测试2', '抽奖测试2', '', 1, '抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2抽奖测试2', 1418918400, 1419523200, 1418885184, '');
...
CREATE TABLE IF NOT EXISTS `qiankun_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='rbac节点表';

-- 正在导出表  qiankun.qiankun_node 的数据：49 rows
...
-- 正在导出表  qiankun.qiankun_orders 的数据：6 rows
...
INSERT INTO `qiankun_orders` (`orderid`, `info`, `userid`, `user_rate_id`, `phone`, `shopid`, `shop_rate_id`, `goodsid`, `price`, `num`, `amount`, `create_time`, `status`, `address`, `point_x`, `point_y`, `paytype`, `is_grab`) VALUES
	...
	('14175911477499', '', 40, 15, NULL, 14, 16, 5, 25, 1, 25, 1417591150, 4, '一个地方', NULL, NULL, 'hdfk', NULL),
	...
	('14187036797071', '一瓶醋', 3, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, 1418703679, 1, '', '111', '222', 'aged', 14);
...
INSERT INTO `qiankun_user` (`id`, `account`, `nickname`, `password`, `bind_account`, `last_login_time`, `last_login_ip`, `login_count`, `verify`, `email`, `phone`, `remark`, `create_time`, `update_time`, `status`, `type_id`, `info`) VALUES
	(1, 'admin', '管理员1', '21232f297a57a5a743894a0e4a801fc3', '', 1418878002, '127.0.0.1', 1008, '8888', 'liu21st@gmail.com', '', '备注信息1', 1222907803, 1414741091, 1, 0, ''),
	...
	(40, 'SH_201411211531424950', '111', 'e10adc3949ba59abbe56e057f20f883e', '', 1418737372, '0.0.0.0', 43, '8066', '', '13191813605', '', 1416555112, 1416555112, 1, 0, '');
